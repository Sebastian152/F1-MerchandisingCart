  ...
  return (
        ...
        <div className="container-xl">
            <div className="row justify-content-center justify-content-md-between">
                <div className="col-8 col-md-3">
                    <a href="index.html">
                        <img className="img-fluid" src="./public/img/logo-F1.png" alt="imagen logo" />
                    </a>
                </div>
                        ...
                        <div id="carrito" className="bg-white p-3">
                            ...
                            <table className="w-100 table">
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <img className="img-fluid" src="./public/img/merch1.jpg" alt="imagen guitarra" />
                                        </td>
                                        <td>Ferrari cap</td>
    ...
    <main className="container-xl mt-5">
        ...
        <div className="row mt-5">
            ...
            <div className="col-md-6 col-lg-4 my-4 row align-items-center">
                <div className="col-4">
                    <img className="img-fluid" src="./public/img/merch2.avif" alt="imagen guitarra"/>
                </div>
                <div className="col-8">
            ...
            <div className="col-md-6 col-lg-4 my-4 row align-items-center">
                <div className="col-4">
                    <img className="img-fluid" src="./public/img/merch3.jpg" alt="imagen guitarra"/>
                </div>
                <div className="col-8">
            ...
            <div className="col-md-6 col-lg-4 my-4 row align-items-center">
                <div className="col-4">
                    <img className="img-fluid flip" src="./public/img/merch4.avif" alt="imagen guitarra"/>
                </div>
                <div className="col-8">
            ...
            <div className="col-md-6 col-lg-4 my-4 row align-items-center">
                <div className="col-4">
                    <img className="img-fluid" src="./public/img/merch5.avif" alt="imagen guitarra"/>
                </div>
                <div className="col-8">
            ...
            <div className="col-md-6 col-lg-4 my-4 row align-items-center">
                <div className="col-4">
                    <img className="img-fluid" src="./public/img/merch6.avif" alt="imagen guitarra"/>
                </div>
                <div className="col-8">
            ...
            <div className="col-md-6 col-lg-4 my-4 row align-items-center">
                <div className="col-4">
                    <img className="img-fluid flip" src="./public/img/merch7.avif" alt="imagen guitarra"/>
                </div>
                <div className="col-8">
            ...
            <div className="col-md-6 col-lg-4 my-4 row align-items-center">
                <div className="col-4">
                    <img className="img-fluid" src="./public/img/merch8.avif" alt="imagen guitarra"/>
                </div>
                <div className="col-8">
            ...
            <div className="col-md-6 col-lg-4 my-4 row align-items-center">
                <div className="col-4">
                    <img className="img-fluid flip" src="./public/img/merch9.avif" alt="imagen guitarra"/>
                </div>
                <div className="col-8">
            ...
            <div className="col-md-6 col-lg-4 my-4 row align-items-center">
                <div className="col-4">
                    <img className="img-fluid flip" src="./public/img/merch10.avif" alt="imagen guitarra"/>
                </div>
                <div className="col-8">
            ...
            <div className="col-md-6 col-lg-4 my-4 row align-items-center">
                <div className="col-4">
                    <img className="img-fluid" src="./public/img/merch11.avif" alt="imagen guitarra"/>
                </div>
                <div className="col-8">
            ...
            <div className="col-md-6 col-lg-4 my-4 row align-items-center">
                <div className="col-4">
                    <img className="img-fluid flip" src="./public/img/merch12.avif" alt="imagen guitarra"/>
                </div>
                <div className="col-8">
